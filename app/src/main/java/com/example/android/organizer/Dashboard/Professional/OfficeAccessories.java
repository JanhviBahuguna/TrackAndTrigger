...
public class OfficeAccessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_office_accessories);

        Toolbar toolbar = findViewById(R.id.Office_accessiories_toolbar);


        recyclerView = findViewById(R.id.recyclerViewOffice_accessiories);
    ...
    private void addItem() {
        ...
        AlertDialog.Builder myDialog = new AlertDialog.Builder(OfficeAccessories.this);
        LayoutInflater inflater = LayoutInflater.from(OfficeAccessories.this);
                ...
                reference.push().setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        if (Item.isSuccessful()) {
                            Toast.makeText(OfficeAccessories.this, "Item has been inserted successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            String error = Item.getException().toString();
                            Toast.makeText(OfficeAccessories.this, "Item insertion failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.office_accessories_retrieved, parent, false);
            ...
            public void onClick(View v) {
                ...
                reference.child(key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        ...
                        if(Item.isSuccessful())
                        {
                            Toast.makeText(OfficeAccessories.this, "Item has been updated successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = Item.getException().toString();
                            Toast.makeText(OfficeAccessories.this, "update failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> item) {
                        if(item.isSuccessful())
                        {
                            Toast.makeText(OfficeAccessories.this, "Item has been deleted successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = item.getException().toString();
                            Toast.makeText(OfficeAccessories.this, "failed to delete Item" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
