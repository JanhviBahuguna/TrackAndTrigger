...
public class HomeAppliances extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.Home_Appliances_toolbar);


        recyclerView = findViewById(R.id.recyclerViewHome_Appliances);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Home_Appliances").child(onlineUserId);

        FloatingActionButton fab = findViewById(R.id.fab_Home_Appliances);
    ...
    private void addItem() {
        ...
        AlertDialog.Builder myDialog = new AlertDialog.Builder(HomeAppliances.this);
        LayoutInflater inflater = LayoutInflater.from(HomeAppliances.this);
                ...
                reference.push().setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        if (Item.isSuccessful()) {
                            Toast.makeText(HomeAppliances.this, "Item has been inserted successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            String error = Item.getException().toString();
                            Toast.makeText(HomeAppliances.this, "Item insertion failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_appliances_retrieved, parent, false);
            ...
            public void onClick(View v) {
                ...
                reference.child(key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        ...
                        if(Item.isSuccessful())
                        {
                            Toast.makeText(HomeAppliances.this, "Item has been updated successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = Item.getException().toString();
                            Toast.makeText(HomeAppliances.this, "update failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> item) {
                        if(item.isSuccessful())
                        {
                            Toast.makeText(HomeAppliances.this, "Item has been deleted successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = item.getException().toString();
                            Toast.makeText(HomeAppliances.this, "failed to delete Item" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
