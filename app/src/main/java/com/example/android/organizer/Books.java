...
public class Books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Books").child(onlineUserId);

        FloatingActionButton fab = findViewById(R.id.fab_books);
    ...
    private void addItem() {
        ...
        AlertDialog.Builder myDialog = new AlertDialog.Builder(Books.this);
        LayoutInflater inflater = LayoutInflater.from(Books.this);
                ...
                reference.push().setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        if (Item.isSuccessful()) {
                            Toast.makeText(Books.this, "Item has been inserted successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            String error = Item.getException().toString();
                            Toast.makeText(Books.this, "Item insertion failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.books_retrieved, parent, false);
            ...
            public void onClick(View v) {
                ...
                reference.child(key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> Item) {
                        ...
                        if(Item.isSuccessful())
                        {
                            Toast.makeText(Books.this, "Item has been updated successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = Item.getException().toString();
                            Toast.makeText(Books.this, "update failed" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> item) {
                        if(item.isSuccessful())
                        {
                            Toast.makeText(Books.this, "Item has been deleted successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String error = item.getException().toString();
                            Toast.makeText(Books.this, "failed to delete Item" + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
